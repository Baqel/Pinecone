...
import static com.ngxdev.tinyprotocol.api.NMSObject.Type.CRAFTITEMSTACK;
import static com.ngxdev.tinyprotocol.api.NMSObject.Type.ITEMSTACK;
...
public abstract class NMSObject {
    ...
    public NMSObject(Object object, Player player) {
        this.object = object;
        this.player = player;
        Pinecone.getInstance().getProfile().start(object.getClass().getName() + " Process");
        process(player, ProtocolVersion.getGameVersion());
        Pinecone.getInstance().getProfile().stop(object.getClass().getName() + " Process");
    }
