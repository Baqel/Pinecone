...
@Getter
public abstract class BaqelArgument {
    private BaqelCommand parent;
    private String name;
    ...
    public BaqelArgument(String name, String display, String description) {
        this.name = name;
        this.display = display;
        this.description = description;
    }

    public BaqelArgument(String name, String display, String description, String... permission) {
        this.name = name;
        this.display = display;
        this.description = description;
