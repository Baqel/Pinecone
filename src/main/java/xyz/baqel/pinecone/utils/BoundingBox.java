...
public class BoundingBox {
    ...
    public List<BoundingBox> getCollidingBlockBoxes(Player player) {
        return Pinecone.getInstance().getBlockBoxManager().getBlockBox().getCollidingBoxes(player.getWorld(), this);
    }
    ...
    public List<Block> getCollidingBlocks(Player player) {
        ...
        Pinecone.getInstance().getBlockBoxManager().getBlockBox().getCollidingBoxes(player.getWorld(), this).forEach(bb -> bb.getMinimum().toLocation(player.getWorld()).getBlock());
        return toReturn;
    }
