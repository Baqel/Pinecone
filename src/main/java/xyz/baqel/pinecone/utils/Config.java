...
public class Config {
    ...
    private String getString(String path) {
        return Pinecone.getInstance().getConfig().getString(path);
    }

    private long getLong(String path) {
        return Pinecone.getInstance().getConfig().getLong(path);
    }

    private int getInt(String path) {
        return Pinecone.getInstance().getConfig().getInt(path);
    }

    private boolean getBoolean(String path) {
        return Pinecone.getInstance().getConfig().getBoolean(path);
    }
}
