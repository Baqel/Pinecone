...
//    public static boolean moved(PineconeLocation from, PineconeLocation to) {
//        return playerMoved(from, to);
//    }

    public static boolean looked(PineconeLocation from, PineconeLocation to) {
...
//    public static boolean playerMoved(PineconeLocation from, PineconeLocation to) {
//        return playerMoved(from.toVector(), to.toVector());
//    }
...
//    }
    ...
    public static boolean playerLooked(PineconeLocation from, PineconeLocation to) {
        return (from.getYaw() - to.getYaw() != 0) || (from.getPitch() - to.getPitch() != 0);
    }
    ...
    public static double getHorizontalDistance(PineconeLocation from, PineconeLocation to) {
        double deltaX = to.getX() - from.getX(), deltaZ = to.getZ() - from.getZ();
        return Math.sqrt(deltaX * deltaX + deltaZ * deltaZ);
    }
    ...
    public static double getVerticalDistance(PineconeLocation from, PineconeLocation to) {
        return Math.abs(from.getY() - to.getY());
    }
    ...
    public static float[] getRotations(PlayersData one, LivingEntity two) {
