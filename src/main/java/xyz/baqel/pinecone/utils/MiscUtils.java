...
public class MiscUtils {
    ...
    public static boolean hasPermissionForAlerts(Player player) {
        return player.hasPermission("pinecone.staff") || player.hasPermission("pinecone.alerts");
    }
    ...
    public static String formatMessages(String message) {
        return Color.translate(Pinecone.getInstance().getMessageFields().prefix + message);
    }
    ...
    public static boolean canCancel(Detection detection, PlayersData data) {
    ...
    public static void printToConsole(String string) {
        Pinecone.getInstance().consoleSender.sendMessage(Color.translate(string));
    }

    public static void send(CommandSender sender, String... messages) {
        for (String message : messages) {
            sender.sendMessage(Pinecone.getInstance().getMessageFields().prefix + message);
        }
    }
}
