...
public class PlayerUtils {
    ...
    public static boolean isRiskyForFlight(PlayersData data) {
    ...
    public static boolean isGliding(Player p) {
        return Pinecone.getInstance().getBlockBoxManager().getBlockBox().isGliding(p);
    }
    ...
    public static double getAccurateDistance(PineconeLocation origin, PineconeLocation point) {
