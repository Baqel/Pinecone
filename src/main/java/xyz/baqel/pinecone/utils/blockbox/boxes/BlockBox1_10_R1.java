...
public class BlockBox1_10_R1 implements BlockBox {
                ...
                for (int y = minY - 1; y < maxY; y++) {
                    ...
                    if (!block.getType().equals(Material.AIR)) {
                        if (BlockUtils.collisionBoundingBoxes.containsKey(block.getType())) {
                            ...
                            net.minecraft.server.v1_10_R1.IBlockData nmsiBlockData = ((CraftWorld) world).getHandle().getType(new BlockPosition(x, y, z));
    ...
    public boolean isGliding(LivingEntity entity) {
        return ((org.bukkit.craftbukkit.v1_10_R1.entity.CraftLivingEntity) entity).isGliding();
    }
