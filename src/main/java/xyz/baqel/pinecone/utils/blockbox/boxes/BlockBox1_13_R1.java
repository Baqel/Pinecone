...
public class BlockBox1_13_R1 implements BlockBox {
                ...
                for (int y = minY; y < maxY; y++) {
                    ...
                    if (!block.getType().equals(Material.AIR)) {
                        if (BlockUtils.collisionBoundingBoxes.containsKey(block.getType())) {
                            ...
                            net.minecraft.server.v1_13_R1.IBlockData nmsiBlockData = ((CraftWorld) world).getHandle().getType(new BlockPosition(x, y, z));
    ...
    public boolean isGliding(LivingEntity entity) {
        return ((org.bukkit.craftbukkit.v1_13_R1.entity.CraftLivingEntity) entity).isGliding();
    }
