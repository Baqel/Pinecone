...
public class BlockBox1_13_R2 implements BlockBox {
                ...
                for (int y = minY; y < maxY; y++) {
                    ...
                    if (!block.getType().equals(Material.AIR)) {
                        if (BlockUtils.collisionBoundingBoxes.containsKey(block.getType())) {
                            ...
                            VoxelShape shape = nmsiBlockData.getCollisionShape(nmsWorld, new BlockPosition(x, y, z));
    ...
    public boolean isGliding(LivingEntity entity) {
        return ((org.bukkit.craftbukkit.v1_13_R2.entity.CraftLivingEntity) entity).isGliding();
    }

    @Override
    public boolean isRiptiding(LivingEntity entity) {
        return ((org.bukkit.craftbukkit.v1_13_R2.entity.CraftLivingEntity) entity).getHandle().isRiptiding();
    }
